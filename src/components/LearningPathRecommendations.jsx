...
function LearningPathRecommendations() {
  ...
  return (
    <div className="mx-auto px-5 flex flex-col justify-center items-center mt-10 sm:mt-36">
      ...
      <div className="lg:w-[1000px] mt-14 mb-14 flex flex-col md:flex-row justify-center gap-y-[10px]">
        ...
        >
          ...
          <LazyLoadImage src="https://images.unsplash.com/photo-1518133910546-b6c2fb7d79e3?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Image" className="w-36 h-24 object-cover" effect="blur" />
        ...
        >
          ...
          <LazyLoadImage src="https://plus.unsplash.com/premium_photo-1683134169138-9037062cba51?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Image" className="w-36 h-24 object-cover" effect="blur" />
        </div>
      </div>
    </div>
  )
