...
function StepThree() {
    ...
    return (
        <div className="mt-10 mb-[2rem] grid md:grid-cols-2 auto-cols-fr gap-y-10 md:gap-x-10">
            <LazyLoadImage src="https://images.unsplash.com/photo-1512314889357-e157c22f938d?q=80&w=1471&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Image" className="my-auto object-cover rounded-md shadow-xl" effect="blur" />
